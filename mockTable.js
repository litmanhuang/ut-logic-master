...
async function fetchCarnapStudentData() {
    // let myCourse = "COURSE-NAME";
    // let instructor = "INSTRUCTOR-EMAIL";
...
// call API second time to retrieve assignment data based on the student id in Carnap. The mock version uses only one version assignment data so problemSubmissionSource() doesn't take the studentId argument.
